...
import org.terasology.entityNetwork.SidedLocationNetworkNode;
...
public class SidedBlockLocationNetworkNodeComponent implements NetworkNodeBuilder {
    ...
    public NetworkNode build(EntityRef entityRef) {
        ...
        if (blockComponent != null) {
            return new SidedLocationNetworkNode(networkId, isLeaf, new Vector3i(blockComponent.getPosition()), calculateConnectionSides(blockComponent));
        } else {
            return null;
        }
    }
